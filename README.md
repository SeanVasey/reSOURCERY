...
<p align="center">
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/version-2.4.4-blue.svg" alt="Version"></a>
...
│   ├── vendor/             # Vendored @ffmpeg/ffmpeg wrapper + util (must be same-origin)
